...
class Cards extends React.Component{
    ...
    handleClick(val, q, c, selectedInd){
        ...
        console.log('send to vis', inputs, this.props.lastAction);
        ...
        if(this.props.lastAction==''){
            console.log('new fix')
            this.props.onAddBtnClick(previous+inputs+'\n'+following, 'off', 'fix', this.props.lineNum);
        }else{
            console.log('add fix to lines')
            this.props.onAddBtnClick(previous+inputs+'\n'+following+'\n'+this.removeQuery(this.props.newCode), 'off', 'fix', this.props.lineNum);
        }
        ...
        CommitObjs = this.props.commit.map(function(s,i){
            ...
            if(i%3==0){
                return <span>
                    ...
                    <CardActions>
                    <FlatButton label="Detail" style={{minWidth:8, height:30}} labelStyle={{fontSize:12}} onClick={() => this.handleChange(s, 'commit',i)}/>
                    <FlatButton label="Fix" style={{minWidth:8, height:30}} labelStyle={{fontSize:12}} onClick={() => this.handleClick(code, resQueries, s, i)}/>
                    </CardActions>
                    </Card></span>;
            }else if(i%4==0){
                return <span>
