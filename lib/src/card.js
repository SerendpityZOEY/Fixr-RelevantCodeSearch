        ...
        CommitObjs = this.props.commit.map(function(s,i){
            ...
            if(i%3==0){
                return <span>
                    ...
                    <CardActions>
                    <FlatButton label="Detail" style={{minWidth:8}} labelStyle={{fontSize:12}} onClick={() => this.handleChange(s, 'commit',i)}/>
                    <FlatButton label="Fix" style={{minWidth:8}} labelStyle={{fontSize:12}} onClick={() => this.handleClick(code, resQueries, s, i)}/>
                    </CardActions>
                    </Card></span>;
            }else if(i%4==0){
                return <span>
