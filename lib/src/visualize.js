...
import Diff from '../backup/diff.js';
...
class Visualize extends React.Component{
    ...
    onAddBtnClick(val) {
        console.log('val', val);
        var prevQuery = this.removeUnused(val);
    ...
    removeUnused(prevCode){
        console.log('ready to remove', prevCode.split('\n'));
        var res = [];
    ...
    render(){
        ...
        />;
            ...
            />;
        else commitDetail = <Trending data={this.state.content}/>;
