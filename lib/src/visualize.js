...
class Visualize extends React.Component{
    ...
    render(){
        ...
        if(this.props.solrConnector.response!=null){
            ...
            /*
            * ============================================
            * for compare.js(table view), no longer needed
            * ============================================
        ...
        <div className="col s12 m12 l12">
            <Tabs>
                ...
                <Tab label="Isomorphism Graph" style={{backgroundColor:'#F5F5F5',color:'#000'}}>
                    <div>
                        <Subheader>Isomorphism Graph(TODO)</Subheader>
                    </div>
                </Tab>
