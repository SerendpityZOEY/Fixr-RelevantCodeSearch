        ...
        return <Grid>
            <Row>
                <Col xs={12} md={4} lg={4} style={{padding:0,position:'relative'}}>
                    <IconButton iconClassName="fa fa-search fa-lg" style={{position:'absolute',zIndex:1, top:0, right:26}} iconStyle={{fontSize:15, color:'#fff'}} onClick={this.onSubmit.bind(this)}>
                        &nbsp;Search</IconButton>
                <CodeMirror value={this.state.code} style={{position:'absolute', zIndex:0}} onChange={this.updateCode.bind(this)} options={options}/>
                </Col>
            </Row>
        </Grid>
    }
