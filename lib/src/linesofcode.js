...
class Lines extends React.Component{
    ...
    handleClick(val) {
        ...
        if(this.props.newCode.length==0 && this.state.multiSelection==false){
            this.props.onAddBtnClick('//'+val.substr(1).trim(), 'off');
            this.setState({
                multiSelection: true,
            })
        }else if(this.props.newCode.length>0 && this.state.multiSelection==false){
            this.props.onAddBtnClick(input + '\n' + '//' + val.substr(1).trim(), 'off');
            this.setState({
                multiSelection: true,
            })
        }else{
            this.props.onAddBtnClick(this.props.newCode + '\n' + '//' + val.substr(1).trim(), 'on');
        }
    }
