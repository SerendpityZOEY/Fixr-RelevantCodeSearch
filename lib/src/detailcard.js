...
class DetailCard extends React.Component{
    ...
    render(){
        ...
        var fileName = commit.name_sni.substr(commit.name_sni.lastIndexOf('/')+1);
        ...
        var temp = <Lines diffcontent={commit.c_patch_t[0]} content={commit.c_contents_t[0]}
                          ...
                          newCode={this.props.newCode} lastAction={this.props.lastAction} lineNum={this.props.lineNum}
        />
