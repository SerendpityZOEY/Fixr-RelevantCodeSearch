...
class ImportInput extends React.Component {
    ...
    render() {
        return <div>
            {this.props.index+2} Import Statement:
...
class Searchpanel extends React.Component{
    ...
    onSubmit(event) {
        ...
        for(var key in this.state.tmpimport){
            if(this.state.tmpimportAction[key]==='undefined') var action = 'modified';
            else action = this.state.tmpimportAction[key];
    ...
    */
    ...
    /*
     ======================================================
     Dynamic Fields (not connect to Solr yet)
     ======================================================
     */
    addInput(){
    ...
    removeImport(){
        ...
        var size = Object.keys(this.state.tmpimport)
